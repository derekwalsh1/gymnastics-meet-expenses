...
class _JudgeImportExportScreenState extends ConsumerState<JudgeImportExportScreen> {
  ...
  Future<void> _exportJudges() async {
    ...
    try {
      final file = await _importExportService.exportJudgesToCsv(includeArchived: false);
      ...
      try {
        ...
        // Share might not work on simulator, show file location instead
        if (!mounted) return;
        showDialog(
          context: context,
          builder: (context) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                const Text(
                  'On a real device, you would see the share sheet to save or share this file.',
  ...
  Future<void> _importJudges() async {
    try {
      ...
      final importResult = await _importExportService.importJudgesFromCsv(file);
  ...
  Future<void> _downloadTemplate() async {
    ...
    try {
      ...
      try {
        ...
        await Share.shareXFiles(
          [XFile(file.path)],
          subject: 'Judge Import Template',
          text: 'Use this template to import judges. Fill in the judge information and import the CSV file.',
          sharePositionOrigin: box != null 
              ? box.localToGlobal(Offset.zero) & box.size
              : null,
        );
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          const Text(
                            'Export all active judges and their certifications to a CSV file. '
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          const Text(
                            'Import judges from a CSV file. The CSV must have the correct format. '
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          const Text(
                            'Tip: A judge can have multiple rows if they have certifications '
                            'in multiple associations/levels.',
                            style: TextStyle(
                              fontSize: 12,
